...
Interactive WordPress plugin for Australian boundaries with admin-managed entries, categories, fuzzy search, and boundary overlays.
...
Both shortcodes support optional parameters to lock the map to a specific geography, set dimensions, and control display options.
